                ...
                <form action="{{ route('bahan-baku.update', $b->id) }}" method="POST">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <input type="number" step="any" name="stok" class="form-control" value="{{ (float)($b->stok->jumlah ?? 0) }}" required readonly>
                        </div>
                        <div class="col-span-12 sm:col-span-6">
            ...
            <form action="{{ route('bahan-baku.store') }}" method="POST">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="number" step="any" name="stok" class="form-control" value="0" readonly>
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        <label class="form-label">Satuan</label>
                        <select name="satuan" class="form-select" required>
