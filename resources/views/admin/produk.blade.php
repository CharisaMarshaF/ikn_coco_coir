...
@section('content')
                        ...
                        @foreach ($produk as $p)
                            <tr class="intro-x">
                                ...
                                <td class="text-center font-bold">
                                    {{-- Menampilkan angka bulat menggunakan number_format tanpa desimal --}}
                                    <span class="{{ ($p->stok->jumlah ?? 0) <= 0 ? 'text-danger' : 'text-success' }}">
                                        {{ number_format($p->stok->jumlah ?? 0, 0, ',', '.') }}
                                    </span>
                                </td>
                                <td>
    ...
    {{-- Modal Laporan PDF --}}
    <div id="modal-laporan-produk" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('produk.laporan') }}" method="GET" target="_blank">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Filter Laporan Mutasi Produk</h2>
                    </div>
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12">
