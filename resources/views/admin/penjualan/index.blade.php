    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="hidden xl:block mx-auto text-slate-500">
            ...
            <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
                ...
                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#modal-laporan-penjualan"
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="w-40 !py-4">
                                        <a href="{{ route('penjualan.show', $p->id) }}"
                                            class="underline decoration-dotted whitespace-nowrap font-medium text-primary">
                                            #PJ-{{ str_pad($p->id, 5, '0', STR_PAD_LEFT) }}
                                        </a>
                                    </td>
                                    <td class="w-60">
                                        <div class="font-medium whitespace-nowrap">
                                            {{ $p->client->nama ?? 'Pembeli Umum (Anonim)' }}</div>
                                    ...
                                    <td class="text-center">
                                        @if ($p->status == 'berhasil')
                                            <div
                                                class="flex items-center justify-center whitespace-nowrap text-success font-medium">
                                                <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> Berhasil
                                            </div>
                                        @elseif($p->status == 'cancel')
                                            <div
                                                class="flex items-center justify-center whitespace-nowrap text-danger font-medium">
                                                <i data-lucide="x-circle" class="w-4 h-4 mr-2"></i> Dibatalkan
                                            </div>
                                        @else
                                            <div
                                                class="flex items-center justify-center whitespace-nowrap text-pending font-medium">
                                                ...
                                                <form action="{{ route('penjualan.cancel', $p->id) }}" method="POST">
                                                    ...
                                                    <div class="p-5 text-center">
                                                        ...
                                                        <div class="text-slate-500 mt-2">
                                                            Transaksi <b
                                                                class="text-slate-700">#PJ-{{ str_pad($p->id, 5, '0', STR_PAD_LEFT) }}</b>
                                                            akan dibatalkan.
                                                            <br>
                                                            <strong class="text-primary">Info:</strong> Stok produk akan
                                                            otomatis dikembalikan ke gudang.
                                                        </div>
                                                    </div>
                                                    <div class="px-5 pb-8 text-center">
                                                        <button type="button" data-tw-dismiss="modal"
                                                            class="btn btn-outline-secondary w-24 mr-1">Tutup</button>
                                                        <button type="submit" class="btn btn-danger w-32 text-white">Ya,
                                                            Batalkan</button>
                                                    </div>
                                                </form>
                                            </div>
        ...
        <div id="modal-laporan-penjualan" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {{-- Form diarahkan ke method cetakPenjualan di Controller --}}
                    {{-- Ganti baris ini --}}
                    <form action="{{ route('laporan.penjualan.cetak') }}" method="GET" target="_blank">
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">Filter Laporan Penjualan</h2>
                        </div>
