    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        @if (auth()->user()->role == 'admin')
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <button data-tw-toggle="modal" data-tw-target="#modal-tambah-user"
                    class="btn btn-primary shadow-md mr-2">Tambah User</button>
            </div>
        @endif
                                        ...
                                        <td class="table-report__action w-56">
                                            <div class="flex justify- items-center">
                                                <a class="flex items-center mr-3 text-primary" href="javascript:;"
                                                    data-tw-toggle="modal" data-tw-target="#modal-edit-{{ $u->id }}">
                                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                                </a>
                                                <a class="flex items-center text-danger" href="javascript:;"
                                                    data-tw-toggle="modal"
                                                    data-tw-target="#modal-delete-{{ $u->id }}">
                        ...
                        <div class="modal-body p-0">
                            <form action="{{ route('users.destroy', $u->id) }}" method="POST">
                                ...
                                <div class="p-5 text-center">
                                    ...
                                    <div class="text-slate-500 mt-2">Data user <b>{{ $u->name }}</b> akan dihapus
                                        secara permanen.</div>
                                </div>
