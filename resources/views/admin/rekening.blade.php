...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button data-tw-toggle="modal" data-tw-target="#modal-tambah-rekening"
                class="btn btn-primary shadow-md mr-2">Tambah Rekening</button>
        </div>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify- items-center">
                                            <a class="flex items-center mr-3 text-primary" href="javascript:;"
                                                data-tw-toggle="modal" data-tw-target="#modal-edit-{{ $r->id }}">
                                                <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                            </a>
                                            <a class="flex items-center text-danger" href="javascript:;"
                                                data-tw-toggle="modal" data-tw-target="#modal-delete-{{ $r->id }}">
                    ...
                    <div class="modal-body p-0">
                        <form action="{{ route('rekening.destroy', $r->id) }}" method="POST">
                            ...
                            <div class="p-5 text-center">
                                ...
                                <div class="text-slate-500 mt-2">Data rekening <b>{{ $r->nama }}</b> akan dihapus
                                    secara permanen.</div>
                            </div>
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12">
                            ...
                            <input type="text" name="nama" class="form-control"
                                placeholder="Contoh: Kas Toko / Bank BCA" required>
                        </div>
                        <div class="col-span-12">
                            <label class="form-label">Jenis</label>
                            <select name="jenis" class="form-select" required>
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="number" name="saldo" class="form-control" placeholder="0" min="0"
                                required>
                        </div>
                    </div>
                    <div class="modal-footer text-right">
