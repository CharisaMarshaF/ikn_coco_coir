    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#modal-laporan-pembelian"
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="w-40 !py-4">
                                        <a href="{{ route('pembelian.show', $p->id) }}"
                                            class="underline decoration-dotted whitespace-nowrap font-medium">
                                            #PB-{{ str_pad($p->id, 5, '0', STR_PAD_LEFT) }}
                                        </a>
                                    </td>
                                    <td class="w-40">
                                        <a href="javascript:;"
                                            class="font-medium whitespace-nowrap">{{ $p->supplier->nama }}</a>
                                    </td>
                                    <td class="text-left">
                                        ...
                                        @elseif($p->status_pembayaran == 'cancel')
                                            <div
                                                class="flex items-center justify-center whitespace-nowrap text-danger font-medium uppercase italic">
                                        ...
                                        <div class="flex justify-center items-center">
                                            ...
                                            @if ($p->status_pembayaran != 'cancel')
                                                <a class="flex items-center text-danger" href="javascript:;"
                                                    ...
                                                    data-tw-target="#modal-cancel-{{ $p->id }}">
                                                    <i data-lucide="x-circle" class="w-4 h-4 mr-1"></i> Cancel
                                                </a>

                                                {{-- Modal Cancel --}}
                                                <div id="modal-cancel-{{ $p->id }}" class="modal" tabindex="-1"
                                                    aria-hidden="true">
                                                            ...
                                                            <div class="modal-body p-0">
                                                                <div class="p-5 text-center">
                                                                    ...
                                                                    <div class="text-slate-500 mt-2">
                                                                        Data tetap tersimpan namun status berubah menjadi
                                                                        <b>Cancelled</b>.<br>
                                                                ...
                                                                <div class="px-5 pb-8 text-center">
                                                                    ...
                                                                    <form action="{{ route('pembelian.cancel', $p->id) }}"
                                                                        method="POST" class="inline">
                                                                        @csrf
                                                                        <button type="submit"
                                                                            class="btn btn-danger w-32">Ya,
                                                                            Batalkan</button>
                                                                    </form>
                                                                </div>
                                                            </div>
        ...
        {{-- Modal Laporan PDF --}}
        <div id="modal-laporan-pembelian" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {{-- Form diarahkan ke method cetakPembelian di Controller --}}
                    {{-- Ganti baris ini --}}
                    <form action="{{ route('laporan.pembelian.cetak') }}" method="GET" target="_blank">
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">Filter Laporan Pembelian</h2>
                        </div>
